...
0x65, 0x76 });
        ...
        protected void signin_Click(object sender, EventArgs e)
        {
            ...
            //an active status
            cmd.CommandText = "select * from tbluser where username= @un and pwd = @pass and status = 1 ";
            ...
            if (dr.HasRows)
            {
                if (dr.Read())
                {
                    ...
                    if (chk)
                    {
                        ...
                        Response.Cookies["password"].Expires = DateTime.Now.AddDays(100);
                    ...
                    Response.Redirect("~/tutorials/week8/updateprofile");
